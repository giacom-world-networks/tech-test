...
Time: You should allocate approx. 2 hours to complete the tech test.
...
Tasks (TBC - Add bug fix / code smell / other issue):
...
Submission: Email development@giacom.com (TBC - Need a new mailbox?) a link to the forked repository or a zip file containing the repository. If applicable, add notes in the email to explain why you have chosen a particular approach.
